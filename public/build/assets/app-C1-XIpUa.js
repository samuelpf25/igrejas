...
const Qe = V("string"),
    ...
    ot = A("URLSearchParams"),
    [it, at, ct, ut] = ["ReadableStream", "Request", "Response", "Headers"].map(
        A
    ),
    lt = (e) =>
...
const ft = (e, t, n, { allOwnKeys: r } = {}) => (
    ...
    dt = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e),
    pt = (e, t, n, r) => {
    ...
    de = "0123456789",
    _e = { DIGIT: de, ALPHA: v, ALPHA_DIGIT: v + v.toUpperCase() + de },
    Ct = (e = 16, t = _e.ALPHA_DIGIT) => {
        let n = "";
        const { length: r } = t;
...
const Pt = (e) => {
    ...
    Ft = A("AsyncFunction"),
    _t = (e) => e && (W(e) || O(e)) && O(e.then) && O(e.catch),
    a = {
        isArray: L,
        isArrayBuffer: Ae,
        isBuffer: Xe,
...
function $(e, t, n) {
    ...
    function u(d, m, R) {
        ...
        if (d && !R && typeof d == "object") {
            if (a.endsWith(m, "{}"))
                ...
                (a.isArray(d) && Bt(d)) ||
                ((a.isFileList(d) || a.endsWith(m, "[]")) && (S = a.toArray(d)))
            )
                return (
                    (m = De(m)),
    ...
    function y(d, m) {
        if (!a.isUndefined(d)) {
            ...
            p.push(d),
                a.forEach(d, function (S, x) {
                    (!(a.isUndefined(S) || S === null) &&
                        s.call(t, S, a.isString(x) ? x.trim() : x, m, b)) ===
...
const je = {
    ...
    kt = typeof URLSearchParams < "u" ? URLSearchParams : ie,
    jt = typeof FormData < "u" ? FormData : null,
    qt = typeof Blob < "u" ? Blob : null,
    Ht = {
        isBrowser: !0,
        classes: { URLSearchParams: kt, FormData: jt, Blob: qt },
        protocols: ["http", "https", "file", "blob", "url", "data"],
    },
    ae = typeof window < "u" && typeof document < "u",
    It = ((e) => ae && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(
    ...
    zt = (ae && window.location.href) || "http://localhost",
    Jt = Object.freeze(
        ...
        return (
            ...
            f
                ...
                : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
                  t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = $t(s[i])),
                  !c)
        );
    }
...
const q = {
    ...
    transformRequest: [
        function (t, n) {
            ...
            return o || s
                ? (n.setContentType("application/json", !1), Kt(t))
                : t;
        },
    ],
    transformResponse: [
...
class g {
    ...
    set(t, n, r) {
        ...
        else if (a.isString(t) && (t = t.trim()) && !Qt(t)) i(Xt(t), n);
...
const we = (e) => (e instanceof g ? { ...e } : e);
function F(e, t) {
    t = t || {};
    const n = {};
    function r(l, u, p) {
        return a.isPlainObject(l) && a.isPlainObject(u)
            ? a.merge.call({ caseless: p }, l, u)
            : a.isPlainObject(u)
            ? a.merge({}, u)
            : a.isArray(u)
            ? u.slice()
    ...
    function s(l, u, p) {
        if (a.isUndefined(u)) {
            if (!a.isUndefined(l)) return r(void 0, l, p);
        } else return r(l, u, p);
    }
    function o(l, u) {
...
const ze = (e) => {
        ...
        (t.headers = i = g.from(i)),
            (t.url = ke(Me(t.baseURL, t.url), e.params, e.paramsSerializer)),
            c &&
                i.set(
                    "Authorization",
                    "Basic " +
    ...
    un =
        ...
        function (e) {
            return new Promise(function (n, r) {
                ...
                u.open(s.method.toUpperCase(), s.url, !0),
                    (u.timeout = s.timeout);
                function p() {
                    if (!u) return;
                    const y = g.from(
                ...
                "onloadend" in u
                    ...
                    (u.onabort = function () {
                        u &&
                            (r(new h("Request aborted", h.ECONNABORTED, s, u)),
                            (u = null));
                    }),
                    (u.onerror = function () {
                        r(new h("Network Error", h.ERR_NETWORK, s, u)),
                            (u = null);
                    }),
        ...
        const s = function (f) {
            if (!r) {
                ...
                n.abort(
                    l instanceof h
                        ? l
                        : new B(l instanceof Error ? l.message : l)
                );
            }
        };
        let o =
    ...
    Je = K && typeof ReadableStream == "function",
    ee =
        K &&
    ...
    z = { stream: te && ((e) => e.body) };
K &&
    ((e) => {
        ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((t) => {
            !z[t] &&
                (z[t] = a.isFunction(e[t])
                    ? (n) => n[t]()
                    : (n, r) => {
                          throw new h(
            ...
            try {
                if (
                    ...
                    a.isFormData(r) &&
                        ...
                        u.setContentType(_),
                        C.body && (r = be(C.body, Re, Ee(x, M(f)), null, ee));
                }
                ...
                if (te && (c || D)) {
                    ...
                    w = new Response(
                        be(w.body, Re, c && Ee(_, M(c, !0)), D && S, ee),
                        C
                    );
                }
                l = l || "text";
...
const Se = (e) => `- ${e}`,
    wn = (e) => a.isFunction(e) || e === null || e === !1,
    Ve = {
        getAdapter: (e) => {
            e = a.isArray(e) ? e : [e];
            const { length: t } = e;
            ...
            for (let o = 0; o < t; o++) {
                ...
                if (
                    ((r = n),
                    !wn(n) &&
                        ((r = ne[(i = String(n)).toLowerCase()]), r === void 0))
                )
...
function ge(e) {
    return (
        ...
        Ve.getAdapter(e.adapter || q.adapter)(e).then(
            function (r) {
                return (
                    Q(e),
...
const re = { assertOptions: bn, validators: ce },
    N = re.validators;
class P {
    constructor(t) {
        (this.defaults = t),
...
a.forEach(["delete", "get", "head", "options"], function (t) {
    P.prototype[t] = function (n, r) {
        return this.request(
            F(r || {}, { method: t, url: n, data: (r || {}).data })
        );
    };
});
