...
<?php $__env->startSection('title','Cadastro Igreja'); ?>

<?php $__env->startSection('content'); ?>

<div class="container mt-5">
    <h1>Cadastrar Igreja</h1>
    <form action="<?php echo e(route('igrejas.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_igreja\igreja\resources\views/igrejas/create_igrejas.blade.php ENDPATH**/ ?>